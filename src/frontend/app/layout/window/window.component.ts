...
import { ConsoleComponent } from 'src/frontend/app/modules/console/console.component';
...
export class WindowComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public readonly windows = {
    ...
    "console-viewer": { body: ConsoleComponent, header: DefaultHeaderComponent, icon: "📜", name: "Console" },
