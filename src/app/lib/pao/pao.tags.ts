...
export class Pao {
  ...
  public static metadata = {
    ...
    "➕lines": { "description": "trim marks for production.\nit works with 📏gutters and 📏bleeds.\n", "tags": ["➕marks"], "name": "lines", "icon": "➕", "codeName": "LINES" },
    "➕cross": { "description": "trim marks added on each corner.\nIt is usefull to assemble  without 📏gutters.\nTherefore this is optimize save papers and trimming time.\n", "tags": ["➕marks"], "name": "cross", "icon": "➕", "codeName": "CROSS" },
